/**
 * @file    font5x7.c
 * @brief   Classic 5x7 column-major ASCII font (0x20..0x7E) plus two scope
 *          glyphs: 0x7F rising edge, 0x80 falling edge. Bit 0 = top row.
 *          95 + 2 glyphs x 5 bytes = 485 bytes of flash.
 */
#include <stdint.h>

const uint8_t g_font5x7[][5] = {
    ...
    {0x40,0x40,0x7F,0x01,0x01}, /* 0x7F rising edge  _|- */
    {0x01,0x01,0x7F,0x40,0x40}, /* 0x80 falling edge -|_ */
};
